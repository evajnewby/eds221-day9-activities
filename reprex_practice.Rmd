...
datapasta::df_paste(head(mack_creek_vertebrates, 5)[, c("WEIGHT", "LENGTH1")])
#> Error in eval(expr, envir, enclos): object 'mack_creek_vertebrates' not found
...
#> 5   6.90      93
   geom_point(aes(shape = 12), color = "purple") +
         ...
         labs(x = "Cutthroat trout length (cm)",
              y = "Weight (g)")
#> Error in geom_point(aes(shape = 12), color = "purple"): could not find function "geom_point"
```
